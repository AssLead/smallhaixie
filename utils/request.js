...
module.exports = {
    ...
    httpsGetRequest:function(req_url,req_obj,res_func)
    {
        ...
        var jsonUrl = {
            url:getApp().globalData.host + req_url,
        ...
        jsonUrl.data.projectId = getApp().globalData.projectId;
    ...
    httpsPostRequest:function(req_url,req_obj,res_func)
    {
        ...
        var jsonUrl = {
            url:'http://www.qplant.vip/VisonShop/' + req_url,
    ...
    {
        dataSource = {
            url:'http://thb.155go.com/webapi/api/index',
            header:{
